...
const styles = StyleSheet.create({
  ...
  label: { ...THEME.typography.bodySmall, color: COLORS.textPrimary, marginBottom: THEME.spacing.sm, fontWeight: '600' },
  inputWrapper: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  errorText: { ...THEME.typography.caption, color: COLORS.error, marginTop: THEME.spacing.xs },
});
